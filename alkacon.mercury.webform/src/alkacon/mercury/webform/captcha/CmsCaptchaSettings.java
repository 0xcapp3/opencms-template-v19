...
public final class CmsCaptchaSettings implements Cloneable {
    ...
    public void init(CmsJspActionElement jsp) {
        ...
        if (parameters.containsKey(C_PARAM_DATA)) {
            ...
            if (data != null) {
                ...
                m_parameterMap = new HashMap<>(dataParameters.size());
    ...
    public void init(CmsObject cms, CmsXmlContent content, Locale locale, int configId) {
        ...
        try {
            m_configId = configId;
            String captchaSettingsPath = CmsFormContentUtil.getContentStringValue(
                content,
                cms,
    ...
    public String toRequestParams(CmsObject cms) {
        ...
        buf.append(PARAM_DELIM).append(C_PARAM_FILTER_WAVE_LENGTH).append(PARAM_KV_SEPARATOR).append(
            m_filterWaveLength);
